package com.example.beresin_uts_10119120.database;
/**
 * NIM : 10119120
...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    public Notes getNote(long id){
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        String[] query = new String[]{KEY_ID,KEY_TITLE,KEY_CONTENT,KEY_CATEGORY,KEY_DATE,KEY_PIN};
        ...
        return new Notes(Long.parseLong(
                cursor.getString(0)),
                cursor.getString(1),
                cursor.getString(2),
                cursor.getString(3),
    ...
    public List<Notes> getNotes(){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                note.setPinned(cursor.getInt(5) > 0);
    ...
    public boolean pin(long id, boolean pin){
        SQLiteDatabase db = this.getReadableDatabase();
        db.execSQL("UPDATE "+DATABASE_TABLE+ " SET pin = " + pin + " WHERE id = " + id);
        return true;
    }
}
